                ...
                <form action="#" class="planner-relative">
                    <div class="col-sm-6">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-5 col-xs-6">
                                <p class="normal-text">11/12/2017</p>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-sm-3 col-xs-6">
                            ...
                            <div class="col-sm-5 col-xs-6">
                                <p class="normal-text text-uppercase">RMU INS 24 MOTORIZED</p>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-sm-3 col-xs-6">
                            ...
                            <div class="col-sm-5 col-xs-6">
                                <p class="normal-text">Tnb Rawang</p>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-sm-3 col-xs-6">
                            ...
                            <div class="col-sm-5 col-xs-6">
                                <p class="normal-text">Direct Item</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6">
